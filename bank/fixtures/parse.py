...
parser.add_argument("--output", help="Output destination", required=True)

if __name__ == "__main__":
    args = parser.parse_args()

    with open(args.input, "r") as input_stream, open(args.output, "w") as output_stream:
        output_stream.write("[\n")
        ...
        for index, obj in enumerate(input_stream):
            ...
            output_stream.write(
                json.dumps({"model": "sensors.sensordata", "pk": index, "fields": obj})
                + ",\n"
